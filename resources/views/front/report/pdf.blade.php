...
<body>
    <header>
        ...
        <div class="columns">
            ...
            <p>
                Afghanistan Jalalabad city <br> office no 2 Haji Mahmood Market</p>
            <div>
                <!-- Display icons using img tags -->
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-info">{{ $subCategoryData->d_sub_category_name }}</span>
                                    </td>
                                    <td>
