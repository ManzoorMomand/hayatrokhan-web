...
@section('button')
<a href="{{ route('admin_news_create_ajax')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
@endsection
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->newsCategory->news_category_name }}</td>>
                                    <td>
                                        @if($row->author_id != 0)
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_news_edit_ajax' ,$row->id)}}" class='far fa-edit'
                                            style='font-size:48px;color:blue'></a>
                                        <a href="{{ route('admin_news_delete_ajax' ,$row->id)}}" class='far fa-trash-alt'
...
<script>
    $(document).ready(function () {
        ...
        $('#createPostForm').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin_news_store_ajax") }}', // Update the route name
                data: formData,
                processData: false,
                contentType: false,
