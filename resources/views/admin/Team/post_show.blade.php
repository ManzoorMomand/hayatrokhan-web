...
@section('button')
<a href="{{ route('admin_team_create_ajax')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_team_edit_ajax' ,$row->id)}}" class='far fa-edit'
                                            style='font-size:48px;color:blue'></a>
                                        <a href="{{ route('admin_team_delete_ajax' ,$row->id)}}" class='far fa-trash-alt'
...
<script>
    $(document).ready(function () {
        ...
        $('#createPostForm').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin_team_store_ajax") }}', // Update the route name
                data: formData,
                processData: false,
                contentType: false,
