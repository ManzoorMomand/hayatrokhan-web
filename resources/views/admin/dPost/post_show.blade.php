...
@section('button')
<a href="{{ route('admin_d_post_create_ajax')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
@endsection
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->rSubCategory->d_sub_category_name }}</td>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_d_post_edit_ajax' ,$row->id)}}" class='far fa-edit'
                                            style='font-size:48px;color:blue'></a>
                                        <a href="{{ route('admin_d_post_delete_ajax' ,$row->id)}}" class='far fa-trash-alt'
