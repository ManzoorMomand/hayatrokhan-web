...
class AdminSubCotegoryController extends Controller
{
        ...
        public function sub_category_store(Request $request)
        {
            ...
            if ($request->hasFile('post_photo')) {
                ...
                return redirect()->route('admin_sub_category_show')->with('success', 'Data is stored successfully.');
            } else {
                return redirect()->route('admin_sub_category_show')->with('error', 'No image file uploaded.');
            }
        }
        ...
        public function sub_Category_update(Request $request, $id)
        {
            ...
            $sub_category = SubCategory::findOrFail($id); // Retrieve the sub_category by ID
        ...
        public function sub_Category_delete($id)
        {
            ...
            if (!$sub_category) {
                return redirect()->route('admin_sub_category_show')->with('error', 'SubCategory not found.');
            }
            ...
            return redirect()->route('admin_sub_category_show')->with('success', 'SubCategory is deleted successfully.');
        }
