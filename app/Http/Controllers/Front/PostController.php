...
class PostController extends Controller
{
    ...
    public function detail($id){
        ...
        return view('front.PostDetail.post_detail', compact('post_detail', 'user_data', 'related_post_array'));
    }
    

    public function news_detail($id){
    
        $post_detail = News::with('newsCategory')->where('id', $id)->first();
        ...
        $related_post_array = News::with('newsCategory')
            ->orderBy('id', 'desc')
            ->where('news_category_id', $post_detail->news_category_id)
            ->get();
    
        return view('front.newspost.post_detail', compact('post_detail', 'user_data', 'related_post_array'));
    }
}
